...
<html>
	...
	<body>
		<div class="intro-text">
			...
			<p><a id="start-button" href="interface.php?session_id=<?php echo uniqid(); ?>&length=5&version=<?php echo (rand(0,1) == 1 ? "category" : "map"); ?>&cycle=initial">Starta kort test</a></p>
			<p><a id="start-button" href="interface.php?session_id=<?php echo uniqid(); ?>&length=20&version=<?php echo (rand(0,1) == 1 ? "category" : "map"); ?>&cycle=initial">Starta hela testet</a></p>
		</div>
	</body>
</html>
